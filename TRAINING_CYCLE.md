...
Last updated: **2026-08-12** (road trip Aug 8–11 extended the Block-2 deload; **Block 3 delayed one week → starts Aug 17**, all later blocks shift +1 week. Week of Aug 10–16 is a bridge/re-regulation week: ~13 easy miles, moderate re-entry lifts, short Sat/Sun at the Maine cabin).
...
- **Weekly frame is fixed:** Mon lower · Tue quality run · Wed upper · Thu easy run · Fri full body · **Sat calisthenics** · **Sun yoga + light jog** (+ short finishing jogs after lifts). One scheduled change ahead, below.
  - **From Block 4 (Sep 14): Saturday = long run first, calisthenics condensed behind it.** Decided 2026-07-28. Same movements, shorter — cut to the anchors, drop the accessory padding. Sunday is unchanged.
...
| **3 — Big 4 retest** | **Aug 17 – Sep 13** | **Strength** | Back Squat, Bench, Deadlift, OHP — beat Block-1 bests | **Hold ~20 mi flat, deload ~14** | Planned |
| **4 — Variation B** | Sep 14 – Oct 11 | **Endurance** | Box or Pause Squat, Close-Grip Bench, Trap-Bar or Deficit Deadlift, Seated DB OHP | **20 → 23 → 26, deload ~18. Sat long run debuts** | Planned |
| **5 — Big 4** | Oct 12 – Nov 8 | Strength | Back Squat, Bench, Deadlift, OHP — beat Block-3 bests | Hold ~26, deload ~18 | Planned |
| **6 — Variation C** | Nov 9 – Dec 6 | Endurance | TBD from the pools | 26 → 29 → 31, deload ~22 | Planned |
| **7 — Big 4** | Dec 7 – Jan 3 | Strength | Big 4 retest | Hold ~31, deload ~22 | Planned |
| **8 — Variation D** | Jan 4 – Jan 31 | Endurance | TBD | 31 → 33 → 35, deload ~25 | Planned |
| 9+ | Feb 1, 2027 → | Alternating | Keep alternating Big-4 / Variation; retest each Big-4 block | **Hold 30–35 indefinitely** (see Endurance goal) | — |
...
|---|---|---|---|
| 3 (strength) | Aug 17 – Sep 13 | **Hold ~20 flat** | Mileage does NOT build here. Maintenance calories + flat running = best possible conditions for the Big-4 retest. **5K TT in the deload week (w/o Sep 7).** |
| 4 (endurance) | Sep 14 – Oct 11 | 20 → 23 → 26 | **Sat long run debuts (~6–8 mi).** First block out of any real deficit |
| 5 (strength) | Oct 12 – Nov 8 | Hold ~26 | Lift PRs |
| 6 (endurance) | Nov 9 – Dec 6 | 26 → 29 → 31 | Long run ~9–10 mi |
| 7 (strength) | Dec 7 – Jan 3 | Hold ~31 | Lift PRs |
| 8 (endurance) | Jan 4 – Jan 31 | 31 → 33 → 35 | Long run ~10–12 mi. **Standing state reached** |
| 9+ | Feb 1, 2027 → | Hold 30–35 | Maintain. Re-benchmark quarterly |
...
- **5K TT gates:** sub-21:00 → sub-20:15 → sub-19:35. Every ~3 months, same route, same conditions, logged here.
...
| **2 — Maintenance** | Aug 10 – Sep 13 (bridge week + Block 3 Big-4 retest, mileage ~flat at 20) | **0** | 189–191, flat | Fuel the PR attempts. Deficit ends here — **out of the deficit before the mileage build starts**, per Brendan's standing constraint |
| **3 — Steady state** | Sep 14 → onward | **100** | ~189 → ~183 by May 2027, then hold | The permanent setting. ~0.9 lb/mo — slow enough to be invisible, slow enough that muscle gain offsets it, small enough that it never compromises a PR or a long run |
...
- **Standing constraint (Brendan, 2026-07-28): no meaningful deficit while run volume is building.** Deficit ends Sep 13, before the Block 4 ramp. The 100 kcal setting from Sep 14 is a rounding error, not a diet — if it ever feels like one, zero it.
