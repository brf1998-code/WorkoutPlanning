...
| **7 — Big 4** | Dec 14 – Jan 10 | Strength | Big 4 retest | Hold ~31, deload ~22 | Planned |
| **8 — Variation D** | Jan 11 – Feb 7 | Endurance | TBD | 31 → 33 → 35, deload ~25 | Planned |
| 9+ | Feb 8, 2027 → | Alternating | Keep alternating Big-4 / Variation; retest each Big-4 block | **Hold 30–35 indefinitely** (see Endurance goal) | — |
...
| 8 (endurance) | Jan 11 – Feb 7 | 31 → 33 → 35 | Long run ~10–12 mi. **Standing state reached** |
| 9+ | Feb 8, 2027 → | Hold 30–35 | Maintain. Re-benchmark quarterly |
...
| Sep 21 (Block 4 wk1) | ramp → **205×2**, back-off 2×4 @180 | Paused 3×5 @165 | 205×2 at ≤2 RIR → attempt can move up a week |
| Sep 28 (wk2) | ramp → **215×1** (1 RIR) then 2×3 @190 | Paused 3×4 @170 | 215 smooth → 225 is a go |
| **Oct 7 (wk3)** | **225 attempt**, fresh, Wednesday, after a normal Tuesday run | Paused 3×5 @160 | Miss → 220 single, retry Oct 14 |
